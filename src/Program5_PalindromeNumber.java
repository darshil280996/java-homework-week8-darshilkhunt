...
Declare and initialize another variable to store the reverse of a number, for example reverse = 0. PRIME TESTING
...
public class Program5_PalindromeNumber {
    ...
    public static boolean isPalindrome(int number) {
        if (number < 0) {
            number = Math.abs(number); // Handle negative numbers by making them positive
        }
